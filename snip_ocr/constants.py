...
SYSTEM_PROMPT_TEMPLATES: dict[str, str] = {
    ...
    "Word/Google Docs": (
        ...
        "Google Docs. Wrap content in a <div dir=\"ltr\" align=\"left\"> and "
        "include <meta charset=\"utf-8\"> at the start. "
        "MANDATORY: render formulas as inline SVG images in <img> tags "
        "using data:image/svg+xml;utf8,... so Google Docs shows them as "
        "images (do NOT use MathML). "
        "Detect the original language of the text. "
        "If the image language does NOT match the requested output language, "
        "translate accurately to the requested language. "
